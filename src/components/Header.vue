<template>
  <header class="header header--user">
      ...
      <div class="container">
        <div class="header-top__inner">
          ...
          <div class="header-top__right">
            <div class="header__language custom_select" :class="{ active: isLanguageOpen }">
              <select @click="toggleLanguage" @blur="closeLanguage">
                <option value="">RU</option>
                <option value="">ENG</option>
              </select>
            </div>
            <div class="user">
              <div class="user__show" @click="toggleUser">
                <div class="user__img">
                  <img src="/images/user-icon5.svg" alt="" />
                </div>
                <div class="user__name">Иван И</div>
              </div>
              <div class="user__hidden" :class="{ 'user__hidden--active': isUserOpen }">
                <div class="user__top">
                  <div class="user__close" @click="closeUser">
                ...
                <ul class="user__list">
                  ...
                  <li class="header__catalog-item2">
                    <div class="item-show" :class="{ 'item-show--active': isSettingsOpenTop }" @click="toggleSettingsTop">
                      <span>Настройки</span>
                      <i>
                        <svg width="11" height="6" viewBox="0 0 11 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M1 1L5.5 5L10 1" stroke="#9F9F9F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                      </i>
                    </div>
                    <div class="item-hidden" :style="{ display: isSettingsOpenTop ? 'block' : 'none' }">
                ...
                <a class="user__exit" href="">
                  <i>
                    <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M9.66663 1.00012L12.5555 1.00012C12.9386 1.00012 13.306 1.1523 13.5769 1.42319C13.8478 1.69408 14 2.06148 14 2.44457L14 12.5557C14 12.9388 13.8478 13.3062 13.5769 13.5771C13.306 13.8479 12.9386 14.0001 12.5555 14.0001L9.66663 14.0001" stroke="#9F9F9F" stroke-width="1.44444" stroke-linecap="round" stroke-linejoin="round"/>
                      <path d="M6.05554 11.1112L9.66665 7.50013L6.05554 3.88901" stroke="#9F9F9F" stroke-width="1.44444" stroke-linecap="round" stroke-linejoin="round"/>
                      <path d="M9.66667 7.50012L1 7.50012" stroke="#9F9F9F" stroke-width="1.44444" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                  </i>
                  <span>Выйти</span>
                </a>
        ...
        <div class="header-bottom__inner">
          <div class="header-bottom__wrap">
            ...
            <div class="header-bottom__right">
              <!-- ДЕСКТОП ВЕРСИЯ КАТАЛОГА -->
              <div class="header-bottom__group">
                <div class="header__catalog">
                  <div class="header__catalog-show" @click="toggleCatalog">
                    <div class="catalog-burger" :class="{ 'catalog-burger--active': isCatalogOpen }">
                      <span></span>
                      <span></span>
                      <span></span>
                      <span></span>
                  ...
                  <!-- ПОЛНЫЙ КАТАЛОГ С ТАБАМИ (для десктопа) -->
                  <div class="header__catalog-hidden" :class="{ 'header__catalog-hidden--active': isCatalogOpen }">
                    <div class="header__catalog-wrap tabs-inner">
                      <div class="header__catalog-head">
                        <a @click.prevent="setActiveTab(1)" :class="{ 'tab--active': activeTab === 1 }" class="header__catalog-tab tab">
                          <i><img src="/images/catalog-icon11.svg" alt="" /></i>
                          <span>Картины</span>
                        </a>
                        <a @click.prevent="setActiveTab(2)" :class="{ 'tab--active': activeTab === 2 }" class="header__catalog-tab tab">
                          <i><img src="/images/catalog-icon12.svg" alt="" /></i>
                          <span>Дом и стиль жизни</span>
                        </a>
                        <a @click.prevent="setActiveTab(3)" :class="{ 'tab--active': activeTab === 3 }" class="header__catalog-tab tab">
                          <i><img src="/images/catalog-icon13.svg" alt="" /></i>
                          <span>Рисунок, графика</span>
                        </a>
                        <a @click.prevent="setActiveTab(4)" :class="{ 'tab--active': activeTab === 4 }" class="header__catalog-tab tab">
                          <i><img src="/images/catalog-icon14.svg" alt="" /></i>
                          <span>Аксессуары</span>
                        </a>
                        <a @click.prevent="setActiveTab(5)" :class="{ 'tab--active': activeTab === 5 }" class="header__catalog-tab tab">
                          <i><img src="/images/catalog-icon15.svg" alt="" /></i>
                          <span>Сумки и кошельки</span>
                        </a>
                        <a @click.prevent="setActiveTab(6)" :class="{ 'tab--active': activeTab === 6 }" class="header__catalog-tab tab">
                          <i><img src="/images/catalog-icon16.svg" alt="" /></i>
                          <span>Украшения</span>
                        </a>
                        <a @click.prevent="setActiveTab(7)" :class="{ 'tab--active': activeTab === 7 }" class="header__catalog-tab tab">
                          <i><img src="/images/catalog-icon17.svg" alt="" /></i>
                          <span>Игрушки и игры</span>
                        </a>
                        <a @click.prevent="setActiveTab(8)" :class="{ 'tab--active': activeTab === 8 }" class="header__catalog-tab tab">
                          <i><img src="/images/catalog-icon18.svg" alt="" /></i>
                          <span>Материалы для творчества</span>
                        </a>
                        <a @click.prevent="setActiveTab(9)" :class="{ 'tab--active': activeTab === 9 }" class="header__catalog-tab tab">
                          <i><img src="/images/catalog-icon19.svg" alt="" /></i>
                          <span>Коллекционирование</span>
                        </a>
                      </div>
                      
                      <div class="header__catalog-body">
                        <div v-show="activeTab === 1" class="header__catalog-content tab__content">
                          <div class="header__catalog-title">Картины<span>456 товаров</span></div>
                          <div class="header__catalog-items">
                            <div class="header__catalog-item">
                              <a href="" class="header__catalog-subtitle">Дом и стиль жизни</a>
                        ...
                        <div v-show="activeTab === 2" class="header__catalog-content tab__content">
                          <div class="header__catalog-title">Дом и стиль жизни<span>456 товаров</span></div>
                          <div class="header__catalog-items">
                            <div class="header__catalog-item">
                              <a href="" class="header__catalog-subtitle">Дом и стиль жизни</a>
                              <ul class="header__catalog-list text-overflow">
                        ...
                        <div v-show="activeTab === 3" class="header__catalog-content tab__content">
                          <div class="header__catalog-title">Рисунок, графика<span>456 товаров</span></div>
                          <div class="header__catalog-items">
                            <div class="header__catalog-item">
                              <a href="" class="header__catalog-subtitle">Дом и стиль жизни</a>
                              <ul class="header__catalog-list text-overflow">
                        ...
                        <div v-show="activeTab === 4" class="header__catalog-content tab__content">
                          <div class="header__catalog-title">Аксессуары<span>456 товаров</span></div>
                          <div class="header__catalog-items">
                            <div class="header__catalog-item">
                              <a href="" class="header__catalog-subtitle">Дом и стиль жизни</a>
                              <ul class="header__catalog-list text-overflow">
                        ...
                        <div v-show="activeTab === 5" class="header__catalog-content tab__content">
                          <div class="header__catalog-title">Сумки и кошельки<span>456 товаров</span></div>
                          <div class="header__catalog-items">
                            <div class="header__catalog-item">
                              <a href="" class="header__catalog-subtitle">Дом и стиль жизни</a>
                              <ul class="header__catalog-list text-overflow">
                        ...
                        <div v-show="activeTab === 6" class="header__catalog-content tab__content">
                          <div class="header__catalog-title">Украшения<span>456 товаров</span></div>
                          <div class="header__catalog-items">
                            <div class="header__catalog-item">
                              <a href="" class="header__catalog-subtitle">Дом и стиль жизни</a>
                              <ul class="header__catalog-list text-overflow">
                        ...
                        <div v-show="activeTab === 7" class="header__catalog-content tab__content">
                          <div class="header__catalog-title">Игрушки и игры<span>456 товаров</span></div>
                          <div class="header__catalog-items">
                            <div class="header__catalog-item">
                              <a href="" class="header__catalog-subtitle">Дом и стиль жизни</a>
                              <ul class="header__catalog-list text-overflow">
                        ...
                        <div v-show="activeTab === 8" class="header__catalog-content tab__content">
                          <div class="header__catalog-title">Материалы для творчества<span>456 товаров</span></div>
                          <div class="header__catalog-items">
                            <div class="header__catalog-item">
                              <a href="" class="header__catalog-subtitle">Дом и стиль жизни</a>
                              <ul class="header__catalog-list text-overflow">
                        ...
                        <div v-show="activeTab === 9" class="header__catalog-content tab__content">
                          <div class="header__catalog-title">Коллекционирование<span>456 товаров</span></div>
                          <div class="header__catalog-items">
                            <div class="header__catalog-item">
                              <a href="" class="header__catalog-subtitle">Дом и стиль жизни</a>
                              <ul class="header__catalog-list text-overflow">
                ...
                <div class="search-mob__btn" @click="toggleMobileSearch" :class="{ 'search-mob__btn--active': isMobileSearchOpen }">
                  <i>
                    <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
             ...
             <div class="user">
               ...
               <div class="user__hidden" :class="{ 'user__hidden--active': isUserOpen }">
                 ...
                 <ul class="user__list">
                   ...
                   <li><a href="">Заказы и доставка</a></li>
                   <li class="header__catalog-item2">
                     <div class="item-show" :class="{ 'item-show--active': isSettingsOpenBottom }" @click="toggleSettingsBottom">
                       <span>Настройки</span>
                       <i>
                         <svg width="11" height="6" viewBox="0 0 11 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                           <path d="M1 1L5.5 5L10 1" stroke="#9F9F9F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                     ...
                     <div class="item-hidden" :style="{ display: isSettingsOpenBottom ? 'block' : 'none' }">
                       <ul class="header__catalog-list">
                         <li><a href="">Настройки</a></li>
                         <li><a href="">Настройки</a></li>
                         <li><a href="">Настройки</a></li>
             ...
             <div class="header__catalog-hidden" :class="{ 'header__catalog-hidden--active': isCatalogOpen }">
               ...
               <div class="header__catalog-items2">
                 <div class="header__catalog-item2">
                   <div class="item-show" :class="{ 'item-show--active': expandedItems.paintings }" @click="toggleCatalogItem('paintings')">
                     <a href="catalog.html">
                       <img src="/images/catalog-icon11.svg" alt="" />
                     </a>
                     <a href="catalog.html">Картины</a>
                   </div>
                   <div class="item-hidden" :style="{ display: expandedItems.paintings ? 'block' : 'none' }">
                     <ul class="header__catalog-list">
                 ...
                 <div class="header__catalog-item2">
                   <div class="item-show" :class="{ 'item-show--active': expandedItems.home }" @click="toggleCatalogItem('home')">
                     <a href="catalog.html">
                       <img src="/images/catalog-icon12.svg" alt="" />
                     </a>
                     <a href="catalog.html">Дом и стиль жизни</a>
                   </div>
                   <div class="item-hidden" :style="{ display: expandedItems.home ? 'block' : 'none' }">
                     <ul class="header__catalog-list">
                       <li><a href="">Пункт номер1</a></li>
                       <li><a href="">Какой то длинный пункт 2</a></li>
                       <li><a href="">Пункт название что то</a></li>
                 ...
                 <div class="header__catalog-item2">
                   <div class="item-show" :class="{ 'item-show--active': expandedItems.graphics }" @click="toggleCatalogItem('graphics')">
                     <a href="catalog.html">
                       <img src="/images/catalog-icon13.svg" alt="" />
                     </a>
                     <a href="catalog.html">Рисунок, графика</a>
                   </div>
                   <div class="item-hidden" :style="{ display: expandedItems.graphics ? 'block' : 'none' }">
                     <ul class="header__catalog-list">
                       <li><a href="">Пункт номер1</a></li>
                       <li><a href="">Какой то длинный пункт 2</a></li>
                       <li><a href="">Пункт название что то</a></li>
                 ...
                 <div class="header__catalog-item2">
                   <div class="item-show" :class="{ 'item-show--active': expandedItems.accessories }" @click="toggleCatalogItem('accessories')">
                     <a href="catalog.html">
                       <img src="/images/catalog-icon14.svg" alt="" />
                     </a>
                     <a href="catalog.html">Аксессуары</a>
                   </div>
                   <div class="item-hidden" :style="{ display: expandedItems.accessories ? 'block' : 'none' }">
                     <ul class="header__catalog-list">
                       <li><a href="">Пункт номер1</a></li>
                       <li><a href="">Какой то длинный пункт 2</a></li>
                       <li><a href="">Пункт название что то</a></li>
                 ...
                 <div class="header__catalog-item2">
                   <div class="item-show" :class="{ 'item-show--active': expandedItems.bags }" @click="toggleCatalogItem('bags')">
                     <a href="catalog.html">
                       <img src="/images/catalog-icon15.svg" alt="" />
                     </a>
                     <a href="catalog.html">Сумки и кошельки</a>
                   </div>
                   <div class="item-hidden" :style="{ display: expandedItems.bags ? 'block' : 'none' }">
                     <ul class="header__catalog-list">
                       <li><a href="">Пункт номер1</a></li>
                       <li><a href="">Какой то длинный пункт 2</a></li>
                       <li><a href="">Пункт название что то</a></li>
                 ...
                 <div class="header__catalog-item2">
                   <div class="item-show" :class="{ 'item-show--active': expandedItems.jewelry }" @click="toggleCatalogItem('jewelry')">
                     <a href="catalog.html">
                       <img src="/images/catalog-icon16.svg" alt="" />
                     </a>
                     <a href="catalog.html">Украшения</a>
                   </div>
                   <div class="item-hidden" :style="{ display: expandedItems.jewelry ? 'block' : 'none' }">
                     <ul class="header__catalog-list">
                       <li><a href="">Пункт номер1</a></li>
                       <li><a href="">Какой то длинный пункт 2</a></li>
                       <li><a href="">Пункт название что то</a></li>
                 ...
                 <div class="header__catalog-item2">
                   <div class="item-show" :class="{ 'item-show--active': expandedItems.toys }" @click="toggleCatalogItem('toys')">
                     <a href="catalog.html">
                       <img src="/images/catalog-icon17.svg" alt="" />
                     </a>
                     <a href="catalog.html">Игрушки и игры</a>
                   </div>
                   <div class="item-hidden" :style="{ display: expandedItems.toys ? 'block' : 'none' }">
                     <ul class="header__catalog-list">
                       <li><a href="">Пункт номер1</a></li>
                       <li><a href="">Какой то длинный пункт 2</a></li>
                       <li><a href="">Пункт название что то</a></li>
                 ...
                 <div class="header__catalog-item2">
                   <div class="item-show" :class="{ 'item-show--active': expandedItems.materials }" @click="toggleCatalogItem('materials')">
                     <a href="catalog.html">
                       <img src="/images/catalog-icon18.svg" alt="" />
                     </a>
                     <a href="catalog.html">Материалы для творчества</a>
                   </div>
                   <div class="item-hidden" :style="{ display: expandedItems.materials ? 'block' : 'none' }">
                     <ul class="header__catalog-list">
                       <li><a href="">Пункт номер1</a></li>
                       <li><a href="">Какой то длинный пункт 2</a></li>
                       <li><a href="">Пункт название что то</a></li>
                 ...
                 <div class="header__catalog-item2">
                   <div class="item-show" :class="{ 'item-show--active': expandedItems.collecting }" @click="toggleCatalogItem('collecting')">
                     <a href="catalog.html">
                       <img src="/images/catalog-icon19.svg" alt="" />
                     </a>
                     <a href="catalog.html">Коллекционирование</a>
                   </div>
                   <div class="item-hidden" :style="{ display: expandedItems.collecting ? 'block' : 'none' }">
                     <ul class="header__catalog-list">
                       <li><a href="">Пункт номер1</a></li>
                       <li><a href="">Какой то длинный пункт 2</a></li>
                       <li><a href="">Пункт название что то</a></li>
         ...
         <div class="search-mob" :class="{ 'search-mob--active': isMobileSearchOpen }">
           <div class="header__search">
             <input type="search" placeholder="Поиск" />
             <button class="header__search-btn open-search">
               <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
   ...
   <div class="header__catalog-bg" :class="{ 'bg--active': isCatalogOpen }" @click="closeCatalog"></div>
 </header>
</template>
...
export default {
 ...
 data() {
   return {
     ...
     isUserOpen: false,
     isSettingsOpenTop: false,
     isSettingsOpenBottom: false,
     isLanguageOpen: false,
     activeTab: 1, // Для десктопных табов
     expandedItems: {
       paintings: false,
       home: false,
       graphics: false,
 ...
 methods: {
   ...
   toggleSettingsTop() {
     this.isSettingsOpenTop = !this.isSettingsOpenTop;
   },
   
   toggleSettingsBottom() {
     this.isSettingsOpenBottom = !this.isSettingsOpenBottom;
   },
   ...
   handleClickOutside(event) {
     const catalogElement = this.$el.querySelector('.header__catalog');
     const burgerElement = this.$el.querySelector('.burger');
     
     if (catalogElement && !catalogElement.contains(event.target) && 
         burgerElement && !burgerElement.contains(event.target)) {
       if (this.isCatalogOpen) {
         this.closeCatalog();
       }
     }
     
     const userElements = this.$el.querySelectorAll('.user');
     let clickedInsideUser = false;
     
     userElements.forEach(userElement => {
       if (userElement.contains(event.target)) {
         clickedInsideUser = true;
       }
     });
     
     if (!clickedInsideUser && this.isUserOpen) {
       this.closeUser();
     }
   },
